...
public class Pedidos implements Serializable {
	...
	/**
	 * @param filtro recebe os parametros da tela referentes ao filtro 
	 * @return Retorna uma lista de pedidos para a tela de filtro
	 */
	...
	/**
	 * @param id do pedido a ser pesquisado
	 * @return Retorna o Pedido que pertence ao ind informado
	 */
